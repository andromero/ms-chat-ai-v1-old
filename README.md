...
b. Must contain letters (both cases without special characters), numbers, or hyphens (-) with up to 80 characters and is mandatory. Cannot start with a hyphen or number.
c. Must end with the suffix -v and the version number with up to 3 digits is mandatory.

###2 - API
a. Must start with the prefix api-
b. Must contain letters, numbers (both cases without special characters), or hyphens (-) with up to 80 characters and is mandatory. Cannot start with a hyphen or number.
c. Must end with the suffix -v and the version number with up to 3 digits is mandatory.
